                     ...
                     int       nCmdShow)
{
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_D2DCONTROLDEMO));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_D2DCONTROLDEMO));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_D2DCONTROLDEMO);
