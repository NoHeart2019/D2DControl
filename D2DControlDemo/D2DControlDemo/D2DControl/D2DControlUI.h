...
struct CD2DBorderEdge {
	...
	CD2DBorderEdge(float width, ED2DLineStyle style, const D2D1_COLOR_F& color)
		: m_width(width), m_style(style), m_color(color), m_dashLength(0.0f), m_gapLength(0.0f) {}
