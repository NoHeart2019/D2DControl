...
struct CD2DCheckboxStyle
{
	...
	{
		// 默认白色勾选框，浅灰边框，圆角 3
		box.background.m_type = CD2DBackground::Solid;
		box.background.m_solid.color = D2D1::ColorF(1.0f, 1.0f, 1.0f);
		box.border.m_top = CD2DBorderEdge(1.5f, Solid, D2D1::ColorF(0.5f, 0.5f, 0.5f));
		box.border.m_right = box.border.m_top;
		box.border.m_bottom = box.border.m_top;
		box.border.m_left = box.border.m_top;
		...
		// 默认白色对勾
		checkmark = D2D1::ColorF(1.0f, 1.0f, 1.0f);
	}
};
