...
struct CD2DSelectStyle
{
	...
	CD2DItemStyle  item;        // 选项样式

	CD2DSelectStyle()
	{
		// 触发器默认样式
		trigger.background.m_type = CD2DBackground::Solid;
		trigger.background.m_solid.color = D2D1::ColorF(1.0f, 1.0f, 1.0f);
		trigger.border.m_top = CD2DBorderEdge(1.0f, Solid, D2D1::ColorF(0.5f, 0.5f, 0.5f));
		trigger.border.m_right = trigger.border.m_top;
		trigger.border.m_bottom = trigger.border.m_top;
		trigger.border.m_left = trigger.border.m_top;
		...
		// 下拉面板默认样式
		dropDown.background.m_type = CD2DBackground::Solid;
		dropDown.background.m_solid.color = D2D1::ColorF(1.0f, 1.0f, 1.0f);
		dropDown.border.m_top = CD2DBorderEdge(1.0f, Solid, D2D1::ColorF(0.5f, 0.5f, 0.5f));
		dropDown.border.m_right = dropDown.border.m_top;
		dropDown.border.m_bottom = dropDown.border.m_top;
		dropDown.border.m_left = dropDown.border.m_top;
