...
class CD2DWindow : public CD2DControlUI, public CD2DRender, public C32Window
{
public:
...
public:
	...
	virtual BOOL CALLBACK OnMouseWheel(WPARAM wParam, LPARAM lParam, LRESULT& lResult);
