	...
	, m_scrollBarVisible(false)
{
	...
	CD2DScrollStyle ss;
	ss.thumb.background.m_type = CD2DBackground::Solid;
	ss.thumb.background.m_solid.color = D2D1::ColorF(0.6f, 0.6f, 0.6f);
	ss.thumb.radius = CD2DRadius(4.0f);
	ss.track.background.m_type = CD2DBackground::Solid;
	ss.track.background.m_solid.color = D2D1::ColorF(0.9f, 0.9f, 0.9f);
