...
void CD2DScrollUI::DrawControl(CD2DRender* pRender)
{
	...
	innerRect.left   += style.border.left.width;
	innerRect.top    += style.border.top.width;
	innerRect.right  -= style.border.right.width;
	innerRect.bottom -= style.border.bottom.width;
